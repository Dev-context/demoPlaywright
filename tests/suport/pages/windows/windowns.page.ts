...
export default class Windows extends Baseclass {
  ...
  readonly openSeperateWindows = this.page.locator(
    elements.open_separete_window
  );
  readonly openMultipleWindowns = this.page.locator(
    elements.open_multiple_window
  );
  readonly clickTabbedWindows = this.page.locator(elements.click_Open_new_tab);
  readonly clickSeperateWindows = this.page.locator(
    elements.click_OpenSeparete
  );
  readonly clickMultipleWindowns = this.page.locator(
    elements.click_Open_Multiple
  );
